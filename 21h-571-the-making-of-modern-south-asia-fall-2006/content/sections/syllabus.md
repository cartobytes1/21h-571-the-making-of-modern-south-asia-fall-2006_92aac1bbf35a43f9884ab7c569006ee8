...
menu:
  leftnav:
    identifier: 5017ce8c5ba49c5738062bfa2f6f249b
    name: Syllabus
    weight: 10
title: Syllabus
type: course
uid: 5017ce8c5ba49c5738062bfa2f6f249b
...
You are required to write **two** critical essays, based on any **two** of the books assigned for this course (please see [readings]({{< baseurl >}}/sections/readings) for a complete list).
...
For more detailed instructions for the essays and informal responses, please see [assignments]({{< baseurl >}}/sections/assignments).
...
| 11 | The Sepoy Mutiny |  |
| {{< td-colspan 3 >}}**6\. The "Jewel in the Crown": India within the British Empire**{{< /td-colspan >}} |||
